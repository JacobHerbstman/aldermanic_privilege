...
ward_bound2005 <- st_read(paste0(root, "merge_wards_tracts/input/CHI_2005/CHI_2005.shp"))
...
ward_bound2015 <- st_read(paste0(root, "merge_wards_tracts/input/CHI_2015/CHI_2015.shp"))
...
census_tracts <- st_read(paste0(root, "clean_tract_data/output/census_tracts.shp"))
...
##write to shapefile
st_write(joined_panel, paste0(root, "merge_wards_tracts/output/census_tract_panel_wards.shp"), append = F)
