...
Purpose: Creates 2006--2022 ward-year demographic controls from Census block-group data.

Controls for 2006--2009 use Census 2000 SF3 counts. Bachelor's-or-higher counts sum the male and female bachelor's, master's, professional, and doctorate categories in table P037. The 2010--2012 controls combine 2010 SF1 population and tenure counts with socioeconomic measures from the 2009--2013 ACS five-year estimates, the earliest ACS block-group data currently available through the Census API. Controls from 2013 onward use the corresponding ACS five-year release.
...
Produces: `output/ward_controls_2006_2022.csv`.
