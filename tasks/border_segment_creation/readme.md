...
The segment file includes `valid_segment`, `invalid_reason`, `analysis_segment_id`, and `segment_lt500ft`/`segment_lt1000ft` fields. Shared assignment loaders keep valid analysis segments and use the length flags only for robustness samples.
