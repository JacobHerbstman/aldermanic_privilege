...
if (nrow(model_row) != 1L) {
  stop("Could not recover the rental RD point estimate.", call. = FALSE)
}
...
ggsave(
  sprintf("../output/rental_rd_flat_bw%.0f_%d_%d_all_controls_panel.pdf", bandwidth_ft, start_year, end_year),
  panel_plot,
  width = 4.8,
  height = 4.1,
  dpi = 300,
