...
The Assessor records no floor area for condominium buildings of `LARGE_BUILDING_UNITS` or more units, so their FAR
cannot be measured. This audit asks whether 2022 footprint area times height could stand in for floor area.
...
Floor area per cubic foot of footprint volume is calibrated on rentals with Assessor floor area, and for large
buildings also on the other large rentals alone (leave one out).
