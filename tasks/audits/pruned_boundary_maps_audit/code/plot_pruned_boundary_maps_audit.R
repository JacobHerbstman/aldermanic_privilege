...
# setwd("/Users/jacobherbstman/Desktop/aldermanic_privilege/tasks/audits/pruned_boundary_maps_audit/code")
...
era_from_year <- function(y) {
  fifelse(
    ...
    fifelse(y < 2015L, "2003_2014",
      fifelse(y < 2023L, "2015_2023", NA_character_)
    )
  )
}

eras <- c("1998_2002", "2003_2014", "2015_2023")
