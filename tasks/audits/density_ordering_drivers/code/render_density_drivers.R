...
writeLines(paste0('<!doctype html><meta charset="utf-8"><title>Who drives the density ordering sensitivity?</title><style>body{font:16px/1.5 system-ui;max-width:1300px;margin:35px auto;padding:0 20px;color:#183445}table{border-collapse:collapse;width:100%;font-size:13px;margin:20px 0}th,td{text-align:left;border-bottom:1px solid #d9e2e7;padding:8px}th{background:#edf3f6}img{max-width:100%}.wide{overflow-x:auto}a{color:#176184}</style>',
  ...
  '<p>Public evidence suggests 81 is a community total that may have been repeated on individual buildings. The <a href="https://www.taylorjohnson.com/tj-news/waterton-acquires-81-unit-apartment-community-in-chicagos-west-loop/">buyer’s acquisition announcement</a> describes an 81-unit community. A <a href="https://yochicago.com/madison-aberdeen-place-apartments-3-n-aberdeen-west-loop/">building profile</a> allocates 18 and 9 units to 3 and 4 N Aberdeen, plus 54 at 20 and 22 N Aberdeen. The <a href="https://www.luxurychicagoapartments.com/blog/pre-leasing-begins-madison-aberdeen-place-west-loop/">original leasing agent</a> confirms two 27-unit buildings at 20 and 22. Recorded new-building permits link 1048 Madison to 3 N Aberdeen and 1100 Madison to 4 N Aberdeen. The individual counts and completion years need reconciliation; no replacement values have been adopted here.</p>',
  '<p>Conditional p-values, sample sizes and log coefficients for every trial are retained in the result files. The interventions are not additive decompositions and do not establish a causal effect of one named alderman. Production data and the paper remain unchanged.</p>',
