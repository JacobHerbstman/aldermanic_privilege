...
ReportData("../output/date_assignment_review.csv")
...
ReportData("../output/date_assignment_possibilities.csv")
...
ReportData("../output/date_cta_review.csv")
...
ReportData("../output/date_summary.csv")
