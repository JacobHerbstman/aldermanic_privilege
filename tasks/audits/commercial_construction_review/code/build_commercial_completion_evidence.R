...
address_permits <- readr::read_csv(
  "../input/commercial_address_permit_history.csv",
  show_col_types = FALSE,
  col_types = readr::cols(
    project_id = readr::col_character(),
    permit_id = readr::col_character(),
...
ground_up <- readr::read_csv(
  "../input/commercial_ground_up_evidence.csv",
  show_col_types = FALSE,
  col_types = readr::cols(project_id = readr::col_character(), .default = readr::col_guess())
) %>%
  select(
...
SaveData(completion_evidence, character(), "../output/commercial_completion_evidence.csv")
