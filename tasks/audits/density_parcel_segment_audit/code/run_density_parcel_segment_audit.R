...
audit <- bind_cols(
  ...
  mutate(
    ...
    regression_base = construction_year >= 2006 & construction_year <= 2022,
    regression_bw100m = regression_base & dist_to_boundary_m <= 100,
    regression_bw500ft = regression_base & dist_to_boundary_m <= density_bandwidth_m,
    regression_bw250m = regression_base & dist_to_boundary_m <= 250,
