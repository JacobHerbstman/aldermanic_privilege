# Construction reconstruction history through September 8, 2026

These are the accumulated research notes, preserved when the current reading guide
was shortened. Earlier counts and pending decisions describe their dated stage;
use [README.md](README.md) for the current build and reading order.
