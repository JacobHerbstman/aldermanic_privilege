...
## Purpose
Assigns date-aware FAR values to the `1999-2026` harmonized rezoning table before geocoding, with parse/lookup diagnostics and unresolved rows for review.
