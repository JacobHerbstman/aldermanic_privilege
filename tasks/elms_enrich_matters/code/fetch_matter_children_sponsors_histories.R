...
# fetch_matter_children_sponsors_histories.R --date-tag 20101201_20260212
...
main <- function() {
  ...
  safe_write(long_df[long_df$child_table == "sponsors", , drop = FALSE], paste0("../output/matter_sponsors_", tag, ".csv"))
  safe_write(long_df[long_df$child_table == "histories", , drop = FALSE], paste0("../output/matter_histories_", tag, ".csv"))
}
