...
parcel_universe <- fread("../temp/parcel_universe_2025_city_native.csv", colClasses = "character")
...
fwrite(parcel_universe, "../output/parcel_universe_2025_city.csv")

ReportData("../output/parcel_universe_2025_city.csv", "pin")
ReportData("../temp/parcel_universe_2025_city_native.csv", "pin")
