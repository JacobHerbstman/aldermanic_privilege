# setwd("tasks/construction_project_candidates/code")
...
family_vintage_rows <- entity_rows %>%
  ...
  summarise(
    ...
    selected_yearbuilt = single_finite_value(yearbuilt),
    selected_reported_units = single_finite_value(reported_units),
    selected_bldgsf = single_finite_value(bldgsf),
    selected_landsf = single_finite_value(landsf),
  ...
  rename(
    ...
    reported_units = selected_reported_units,
    bldgsf = selected_bldgsf,
    landsf = selected_landsf
  )
