...
\title[Aldermanic Privilege]{Does Regulatory Uncertainty Reduce Housing Supply? Evidence from Chicago's Aldermanic Privilege}
...
% APPENDIX A: Uncertainty Score Validation
