...
\begin{frame}
    ...
    \hfill
    \hyperlink{treatment-example-13-23}{\beamergotobutton{Citywide Maps}}
\end{frame}
...
\begin{frame}[label=price-main]
    ...
    \vspace{0.2em}
    \small
    Home prices show small positive effects with wide confidence intervals. \\
...
% ==============================================================================
\begin{frame}
    \frametitle{Difference-in-Differences Estimates: Home Prices}
    ...
    \vspace{0.3em}
    \normalsize
    $\Rightarrow$ No-hedonics and hedonics DiD estimates remain small and positive.
