...
\begin{frame}
	...
	\begin{enumerate}
		...
		\item \textit{Home prices after redistricting}: Event study when census blocks are reassigned to different aldermen
	\end{enumerate}

	\textbf{Preview of Results}
	\begin{enumerate}
		\item Stricter aldermen lower multifamily density by $13-15\%$ near ward borders
		\item Census blocks redistricted to stricter aldermen show modest positive home-price effects in stacked DiD specifications
	\end{enumerate}
\end{frame}
