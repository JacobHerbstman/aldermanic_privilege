...
\begin{frame}
	...
	\vspace{0.5em}
	\textbf{Empirical strategy}: Border-pair fixed effects regressions at ward boundaries
	\begin{itemize}
		\item Stringent fixed effects allow me to isolate the effect of regulatory uncertainty within small, homogeneous areas 
	\end{itemize}

	\vspace{0.3em}
	\textbf{Preview of Results}
	\begin{enumerate}
		\item More uncertain aldermen $\Rightarrow$ $12{-}18\%$ lower multifamily density near ward borders
