...
\begin{frame}
	...
	\begin{figure}
		\centering
		\includegraphics[width=0.9\textwidth, height=0.9\textheight, keepaspectratio]{images/home_price_growth.png}
	\end{figure}
\end{frame}
...
\begin{frame}
	...
	\textbf{Research Question}: Does the heterogeneity in regulatory stringency induced by the unique institution of aldermanic privilege reduce housing supply and raise prices?
