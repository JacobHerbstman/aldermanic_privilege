...
packages <- c(
  "DBI", "readr","fixest","haven","stringr", "ipumsr", "tidycensus","collapse","dplyr","sf", "furrr", "nngeo", "data.table", 
  "tigris", "zoo", "patchwork", "glue", "writexl", "arrow", "duckdb", "ptaxsim", "ggplot2"
)
