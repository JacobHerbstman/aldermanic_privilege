...
Low-discretion applications show a more muted response.

\begin{table}[htbp]
    \centering
    \caption{Assigned Stringency and Permit Applications After Redistricting}
...
The response is more muted than for high-discretion applications.
...
\begin{figure}[htbp]
    ...
    \caption{Event Study: Low-Discretion Permit Applications}
    ...
    The pooled post-period coefficient is $-0.051$ (SE $=0.034$; $p=0.139$).
    Joint pre-trend test $p=0.345$.}
...
The estimated annual flow of high-discretion permit applications is 11.9\% lower.
...
\begin{figure}[htbp]
    ...
    Points report $\exp(\hat\beta_\tau)-1$; shaded areas are 95\% confidence intervals based on standard errors clustered by ward pair.
    The pooled post-period coefficient is $-0.127$ (SE $=0.039$), implying that the annual flow of applications is 11.9\% lower on average in years 0--5.
    Joint pre-trend test $p=0.798$.}
