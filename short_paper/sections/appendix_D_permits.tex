...
\begin{table}[htbp]
    ...
    Each model includes block fixed effects, ward-pair $\times$ year fixed effects, and pre-period high-discretion permit volume and its zero-volume indicator interacted with year.
