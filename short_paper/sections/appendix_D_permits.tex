...
\begin{figure}[htbp]
    ...
    The pooled post-period coefficient is $-0.046$ (SE $=0.032$; $p=0.153$).
    Joint pre-trend test $p=0.459$.}
...
\begin{figure}[htbp]
    ...
    Points report $\exp(\hat\beta_\tau)-1$; shaded areas are 95\% confidence intervals based on standard errors clustered by ward pair.
    The pooled post-period coefficient is $-0.133$ (SE $=0.039$), implying that the annual number of recorded permits is 12.4\% lower on average in years 0--5.
    Joint pre-trend test $p=0.808$.}
