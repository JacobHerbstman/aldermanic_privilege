...
I regress permit-level log processing time on ward geographic characteristics (distance to the CBD, distance to the lake, CTA station density), demographic controls (median household income, homeownership rate, population, racial composition), lagged ward-month permit volume, and fixed effects for year-months, permit type, and review type.
...
The specification controls for ward characteristics and lag permit volume while partialing out month, permit-type, and review-type fixed effects, since review and permit-type composition may be endogenously determined by the regulatory environment.
...
\begin{table}[htbp]
    \caption{Stage 1 Residualization: Permit-Level Log Processing Time on Ward Characteristics}
    \label{tab:stage1_residualization}
    \input{../tasks/audits/income_score_current_results/output/income_score_stage1_2022.tex}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{../tasks/audits/income_score_current_results/output/income_score_distribution_2022.pdf}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.72\textwidth]{../tasks/audits/income_score_current_results/output/income_score_predecessor_successor_2022.pdf}
