...
Using 2015 ward redistricting as identifying variation, I use a complementary event study approach to show that a one-standard-deviation increase in assigned stringency reduces the annual flow of high-discretion permit applications by about 10\% in the five years following the remap.
I also find suggestive downstream evidence on housing costs: listed rents are about 3.5\% higher and home sale prices are about 1.7\% higher on the more stringent side of ward boundaries after adjusting for observed unit and amenity differences.
