...
For multifamily new construction, floor-area ratio (FAR) is about $23\%$ lower and dwelling units per acre (DUPAC) is about $30\%$ lower on the more stringent side of the boundary.
The all-construction estimates point in the same direction but are smaller, at about $10\%$ lower FAR and $14\%$ lower DUPAC.
...
Using this within-census-block variation, I find that a one-standard-deviation increase in assigned stringency reduces the annual flow of high-discretion permit applications by 9.2\% in the five years following the remap, relative to nearby blocks whose ward assignment does not change.
...
Home sale prices also appear to be slightly higher on the more stringent side, at about 1.2\%.
