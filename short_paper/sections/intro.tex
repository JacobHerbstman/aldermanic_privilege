...
To separate redistricting from the 2015 election, I keep only comparisons where the aldermen serving both the origin and destination wards remained in office through the transition.
I also estimate the stringency scores for this design using only permits filed through 2014.
Using this within-census-block variation, I find that a one-standard-deviation increase in aldermanic stringency reduces `high-discretion' permit applications by 13.2\% over the next 5 years, relative to nearby blocks whose regulatory environment does not change.
