...
For multifamily new construction, a one-standard-deviation increase in aldermanic stringency lowers floor-area ratio (FAR) by about $11\%$ and dwelling units per acre (DUPAC) by about $10\%$.
In the binary comparison, multifamily FAR is about $20\%$ lower and DUPAC about $24\%$ lower on the more stringent side of the boundary.
The all-construction estimates are much smaller and statistically indistinguishable from zero.
...
Using this within-census-block variation, I find that a one-standard-deviation increase in assigned stringency reduces the annual number of high-discretion permits recorded by the city by 9.5\% in the five years following the remap, relative to nearby blocks whose ward assignment does not change.
