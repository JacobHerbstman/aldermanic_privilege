...
Multifamily FAR is about $24\%$ lower and DUPAC about $28\%$ lower on the more stringent side of the boundary.
A continuous specification based on the score difference between neighboring aldermen gives the same pattern: at a boundary where their scores differ by one standard deviation, multifamily FAR is about $20\%$ lower and DUPAC about $16\%$ lower on the more stringent side.
