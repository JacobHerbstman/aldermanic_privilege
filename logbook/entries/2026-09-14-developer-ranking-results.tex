...
\textit{Historical orientation: higher raw funding. See the later donation-based stringency entry.}
...
\path{../output/developer_results.html}. Benchmark producers and hashes are in
\path{sources/benchmark_sources.csv}; local copies are in \path{data_raw/score_robustness/}.
Donation receipts come from the preceding audit at \texttt{bc100d9b}.
