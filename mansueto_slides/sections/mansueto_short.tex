...
\begin{frame}[label=visual-rd-main]
    ...
    \begin{column}{0.48\textwidth}
        \centering
        \textbf{All Construction}
        \begin{figure}
            \includegraphics[width=\textwidth,height=0.59\textheight,keepaspectratio]{../tasks/nonparametric_rd_density_linear_display/output/nonparametric_rd_density_linear_display_log_density_dupac_500ft_all_bins5.pdf}
        \end{figure}
    \end{column}
    \begin{column}{0.48\textwidth}
        \centering
        \textbf{Multifamily}
        \begin{figure}
            \includegraphics[width=\textwidth,height=0.59\textheight,keepaspectratio]{../tasks/nonparametric_rd_density_linear_display/output/nonparametric_rd_density_linear_display_log_density_dupac_500ft_multifamily_bins5.pdf}
        \end{figure}
    \end{column}
    \end{columns}
    \scriptsize
...
\begin{frame}
    ...
    \begin{center}
        ...
        \includegraphics[width=0.99\textwidth,height=0.62\textheight,keepaspectratio,trim=0.8cm 3.3cm 0.8cm 3.5cm,clip]{../tasks/event_study_treatment_maps/output/ward_pair_horizontal_13-23_1000ft.pdf}
    \end{center}
    \vspace{-0.2em}
    \scriptsize
