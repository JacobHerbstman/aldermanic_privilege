...
I exclude permits in the ``Easy Permit Process,'' ``Express Permit Program,'' ``Elevator Equipment,'' ``For Extension of PMT,'' ``Scaffolding,'' and signs categories. These exclusions target permit types that bypass standard aldermanic review and thus do not reflect aldermanic influence on development.
...
Sale prices are first deflated to 2022 dollars using monthly Chicago CPI and then winsorized at the 1st and 99th percentiles to limit the influence of outliers on mean calculations.
