...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.98\textwidth]{../tasks/strictness_score_map/output/uncertainty_score_map_comparison.pdf}
    \caption{Geographic Distribution of Regulatory Stringency in 2014 and 2022}
    \figurenotes{Both panels use the stringency scores estimated from permit records through December 2022.
    Panel A maps the scores of aldermen serving in January 2014 onto the January 2014 wards; Panel B does the same for January 2022.
