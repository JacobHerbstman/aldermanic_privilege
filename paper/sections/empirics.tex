...
\begin{table}[htbp]
    ...
    % 2. Input the file directly (NO \resizebox)
    \input{../tasks/border_pair_FE_regressions/output/fe_table_bw250.tex}
    
    \footnotesize
    \textit{Notes:} Standard errors are clustered at the ward-pair level. 
    The outcome variables are logged to interpret coefficients as percentage changes.
 \end{table}