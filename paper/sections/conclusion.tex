...
Using 2015 ward redistricting as identifying variation, I find that reassignment toward greater stringency reduces the annual number of high-discretion permits recorded by the city by about 12\% in the five years following the remap.
A boundary comparison shows that new construction is less dense on the more stringent side of ward boundaries, with multifamily FAR about 14\% lower and dwelling units per acre about 18\% lower immediately across the boundary.
Listed rents are about 1.7\% higher immediately across the boundary after adjusting for observed unit and amenity differences, although the estimate is imprecise; home sales provide suggestive evidence of prices about 4.6\% higher.
