...
\begin{figure}[htbp]
    ...
    The pooled log contrast is $-0.147$ (SE $=0.050$).
    The equal-and-opposite test for the pooled coefficients has $p=0.172$, and the joint pre-trend test has $p=0.472$.}
