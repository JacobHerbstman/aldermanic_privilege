...
The joint test across all listed characteristics has a $p$-value of 0.350.
...
The annual number of high-discretion permits is 8.2\% lower, a somewhat smaller estimate than in the main sample.
...
\begin{figure}[htbp]
    ...
    The pooled effects correspond to reductions of 1.7\% and 8.2\% in annual permits, respectively.
    Tests that the pre-2015 effects are jointly zero give $p=0.074$ in Panel A and $p=0.670$ in Panel B.
...
\begin{table}[htbp]
    ...
    Panel B reports Pearson correlations. Each observation represents one ward in one month.
\end{table}
