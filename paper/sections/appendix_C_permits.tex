...
\begin{table}[htbp]
    ...
    \footnotesize
    \textit{Notes:} Poisson pseudo-maximum likelihood estimates use census-block-year observations from 2010--2020 within 500~ft of a ward boundary.
...
\begin{table}[htbp]
    ...
    \footnotesize
    \textit{Notes:} The sample uses positive-duration permit records with applications begun through December 2022.
