...
\begin{figure}[htbp]
    ...
    \figurenotes{Panel A uses low-discretion permits excluding signs; Panel B adds blocks from wards with aldermanic turnover while retaining treatment based on the 2014 incumbents.
    ...
    The joint pre-trend tests give $p=0.066$ in Panel A and $p=0.665$ in Panel B.
