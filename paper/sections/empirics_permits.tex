...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.62\textwidth]{../tasks/event_study_sales_diagnostics/output/treatment_control_map_2015_1000ft.pdf}
...
\begin{figure}[htbp]
    ...
    \figurenotes{Block-year PPML event study. Outcome is the count of high-discretion permits issued per block per year. 2015 redistricting cohort; sample restricted to blocks within 1000ft of ward boundaries with uniform weights. Continuous treatment: effect of a 1 SD increase in alderman stringency. Block and border-pair $\times$ year fixed effects. Year $-1$ omitted as reference. 95\% confidence intervals based on standard errors clustered at the block level. Pooled post-period estimate: $-0.070$ (SE $= 0.036$). Joint pre-trend test $p = 0.810$.}
