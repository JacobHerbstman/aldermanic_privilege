...
Since this data is limited to parcels that have at most 6 units of housing, I then use the Commercial Valuation dataset from Cook County to infer multifamily housing density 
...
While this could be evidence that my strictness scores are not capturing pro vs. anti-development sentiment, 
...
In order to disentangle the effect of aldermanic influence from demand-side factors and neighborhood trends, more sophisticated empirical strategies are needed, as I discuss in Sections ~\ref{sec:empirical_results_density} and ~\ref{sec:empirical_results_rent_home_vals}.
