...
In addition, both have positive average ``strictness scores'' as defined in Section~\ref{sec:empirical_results}. 
...
In order to distentangle the effect of aldermanic influence from demand-side factors and neighborhood trends, more sophisticated empirical strategies are needed, as I discuss in Section~\ref{sec:empirical_results}.
