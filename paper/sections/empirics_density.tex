...
I also provide a version of the results where I drop a handful of new developments that are feasibly close to a different border segment to avoid conflating different segments.
