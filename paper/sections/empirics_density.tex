...
Panel A uses the standardized aldermanic stringency score, while Panel B reports the binary version of the comparison visualized in Figure~\ref{fig:rd_fe_plots}.
