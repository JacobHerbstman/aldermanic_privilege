...
I first adjust processing times for ward demographics, permit location, permit and review type, application month, and recent permit volume.
...
I first use the 2015 ward redistricting to test whether permitting changes when a block is reassigned to a different ward, keeping location fixed.
...
I then estimate effects on completed housing by comparing new construction near ward boundaries.
On one side, developers deal with one alderman; across the street, they deal with another.
The neighborhood and statutory zoning are similar, but the informal regulatory environment changes sharply.
Among multifamily projects immediately across a ward boundary, FAR is about 14\% lower and dwelling units per acre about 18\% lower on the more-stringent side.
The estimates for all new construction are similar.
...
Listed rents are about 1.7\% higher immediately across the boundary after controlling for listing characteristics and nearby amenities, although the estimate is imprecise.
Home sales provide suggestive evidence of prices about 4.6\% higher.
