...
My density estimates capture that margin, but they also speak to a broader margin of realized development, since allowed density and realized built density can differ substantially, especially in the presence of discretionary review \citep{rollet_zoning_2025}.
Neither my estimates nor those in \citet{khan_decentralized_2021} can capture the deterrence margin: projects that are never proposed because developers anticipate rejection or sort into more friendly locations elsewhere.
