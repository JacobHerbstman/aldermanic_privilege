...
The pre-trends are not distinguishable from zero, and the post-redistricting estimate continually declines through the 5 year period and the pooled post-period estimate is $-0.127$ (SE $=0.049$), equivalent to an 11.9\% reduction in the annual number of high-discretion permits associated with a move toward greater stringency.
...
It appears that aldermanic discretion comes from uniquely stringent aldermen blocking activity that would otherwise have occurred, rather than uniquely lenient aldermen allowing activity that would generally be blocked under formal city regulations.
...
Listed rents are 1.7\% higher in the band closest to the boundary, although the estimate is imprecise.
Home sale prices are 4.6\% higher in the band closest to the boundary.
