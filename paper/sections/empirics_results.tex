...
The pooled 2015--2020 estimate is $-0.127$ (SE $=0.049$), equivalent to an 11.9\% reduction in the annual number of high-discretion permits associated with a move toward greater stringency.
...
\begin{figure}[htbp]
    ...
    Panel A's pooled coefficient of $-0.127$ corresponds to an 11.9\% reduction in annual permits for assignment toward greater stringency.
    Shaded areas are 95\% confidence intervals based on standard errors clustered by ward pair.
    The test that the pre-2015 effects in Panel A are jointly zero gives $p=0.394$.
...
\begin{figure}[htbp]
    ...
    The right panel uses 58,735 sales of detached houses, townhouses, and apartment buildings with two to six units from 2006--2022, with segment-by-quarter fixed effects.
