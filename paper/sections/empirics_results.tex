...
The pre-period coefficients show no systematic divergence, and the pre-trend test has a $p$-value of 0.390.
...
\begin{figure}[htbp]
    ...
    The pooled coefficient is $-0.124$ (SE $=0.046$), and the pre-trend test has $p=0.390$.}
