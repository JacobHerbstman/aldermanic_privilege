...
The decline in permitting activity comes mostly from moves toward more stringent aldermen, which reduce high-discretion permits by 20.7\%; blocks assigned toward more lenient aldermen experience a 7.0\% increase.
...
\begin{figure}[htbp]
    ...
    The test that the pre-2015 effects in Panel A are jointly zero gives $p=0.400$.
