...
\begin{figure}[htbp]
    ...
    Points show proportional changes relative to 2014, so 0.10 means a 10\% increase.
    Subtitles report pooled 2015--2020 coefficients in logs.
    Shaded areas are 95\% confidence intervals based on standard errors clustered by ward pair.
    The joint pre-trend test in Panel A gives $p=0.394$.
