...
The term $\lambda_{t(i)}$ denotes property-type fixed effects: cleaned listing building type for rents and Cook County Assessor property class for sales.
Standard errors are clustered by ward pair.
...
Home sale prices are 2.9\% higher on the more-stringent side relative to the less-stringent side.
...
\begin{figure}[htbp]
    ...
    Panel B uses 58,735 filtered residential transactions from 2006--2022 and segment-by-quarter fixed effects.
