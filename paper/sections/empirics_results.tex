...
The post-redistricting estimates become increasingly negative over the five-year period.
...
The decline in permitting activity comes mostly from moves toward more stringent aldermen, which reduce high-discretion permits by 23\%; blocks assigned toward more lenient aldermen experience a 6.5\% increase.
...
\begin{figure}[htbp]
    ...
    Each point is the estimated difference between a 100~ft distance band and the band immediately inside the less-stringent side, which is normalized to zero.
