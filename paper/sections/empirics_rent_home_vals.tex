...
The rental results are more suggestive than definitive, but are robust to including listing-level hedonic controls as shown in Appendix~\ref{sec:appendix_sales_rental}.
...
Table~\ref{tab:did_pooled} in Appendix~\ref{sec:appendix_sales_rental} presents pooled difference-in-differences estimates that summarize the average post-period effect.
