...
\begin{frame}[label=strictness-main]
    ...
    \centering
    \vspace*{-0.4em}
    \includegraphics[width=\textwidth,height=0.8\textheight,keepaspectratio]{../tasks/presentation_figures/output/stringency_map_2007_2014_2022_slides.pdf}
    \par\vspace{-0.3em}
    {\footnotesize Scores use 2006--2022 processing times; all maps use the same scale.}\hfill
    \hyperlink{score-plot-appendix}{\beamergotobutton{Distribution}}
