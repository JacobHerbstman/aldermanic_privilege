...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item But uncertainty and discretion are also key determinates of housing supply and are far less studied
		\end{itemize}
...
\begin{frame}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item Both cities have seen below-median rent and home price growth compared to peer cities
		\end{itemize}
	\end{itemize}
\end{frame}
...
\begin{frame}
	...
	\begin{enumerate}
		\item Stricter aldermen lower multifamily density by $10-16\%$ near ward borders
		\item Census blocks that are redistricted to stricter aldermen see rent increases of $3-5\%$ and home price increases of $2\%$
	\end{enumerate}
\end{frame}
