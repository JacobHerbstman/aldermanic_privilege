...
\begin{frame}[label=density-reg-main]
    ...
    \vspace{0.2em}
    \tiny\textit{Geometry risk disclosure}: Main estimates use the all-sample table; pruned pair-era sensitivity (dropping confounded and missing-flag pair-eras) is shown as a credibility check. Distances are map-year ward-constrained nearest-border assignments, not global-nearest borders.
