...
\begin{frame}
    ...
    \begin{itemize}[itemsep=0.25em,topsep=0.2em,parsep=0pt,partopsep=0pt]
      ...
      \item Higher rents on the more-stringent side suggest that this mechanism may impact housing affordability.
    \end{itemize}
    ...
    \begin{itemize}[itemsep=0.25em,topsep=0.2em,parsep=0pt,partopsep=0pt]
      ...
      \item The results suggest that reforms to increase housing supply should also target who holds decision-making authority.
    \end{itemize}
\end{frame}
