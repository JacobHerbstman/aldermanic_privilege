...
\title[Aldermanic Privilege]{Informal Regulation and Housing Supply: Evidence from Chicago's Aldermanic Privilege}
\author[Jacob Herbstman]{Jacob Herbstman (University of Chicago)}
\date{\parbox{\linewidth}{September 2026\par\vspace{1.5em}\centering 2026 North American Meeting of the Urban Economics Association}}
...
% PART 1: MOTIVATION & INSTITUTIONAL SETTING
...
% PART 6: PERMIT REASSIGNMENT RESULTS
\input{sections/permit_results.tex}

% PART 7: DENSITY ANALYSIS
\input{sections/density_analysis.tex}

% PART 8: HOUSING COSTS
...
\begin{frame}[allowframebreaks]{References}
    ...
    \bibliography{../paper/sections/aldermanic_privilege}
\end{frame}
%---------------------------------------------------------------------
...
% APPENDIX C: Permit Reassignment
\input{sections/appendix_permits.tex}

% APPENDIX D: Density Analysis
\input{sections/appendix_density.tex}

% APPENDIX E: Rents and Home Sales
